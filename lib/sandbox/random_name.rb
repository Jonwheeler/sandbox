...
module Sandbox
  class RandomName
    ...
    NOUNS = %w(
     ...
     quiet white cool spring winter long late lingering bold little morning 
     muddy old red rough still small sparkling throbbing shy wandering 
